...
export function makeCreateVisitationUseCase() {
  ...
  const visitControlMeasureRepository =
    new TypeormVisitControlMeasureRepository()
  const visitContainersRepository = new TypeormVisitContainersRepository()
  const createVisitationUseCase = new CreateVisitationUseCase(
    houseRepository,
    visitationRepository,
    visitControlMeasureRepository,
    visitContainersRepository
  )
