...
export default function RegisterArea(){
    ...
    return(
        ...
        <InputForm control={control} name="area" title="Área" errorMessage={errors.area?.message} keyboardType="numeric"/>
        <View className="flex-row gap-4">

        <Pressable onPress={()=>router.back()} className="w-32 h-14 justify-center items-center  my-2 rounded-xl bg-red-200">
            <Text>Cancelar</Text>
        </Pressable>
        <Pressable className="w-32 h-14 justify-center items-center  my-2 rounded-xl bg-teal-500">
